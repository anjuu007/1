       ...
       if(event.equals("submit"))
        {
            if(accno.equals("")|| uname.equals("")|| pass.equals("")|| amt.equals(""))
                   ...
                   out.println("   location='withdraw_form.jsp';            ");
                   out.println("   </script>                           ");
                    }
            ...
            else
            {
                try
                {
                    ...
                    if(uname.equals(session.getAttribute("username")) && pass.equals(session.getAttribute("password")))
                    {
                                 ...
                                 String sql2 = "select * from new_acc where user_id = '"+session.getAttribute("user_id")+"'  ";
                                 ...
                                 if(rs2.next())
                                    ...
                                    String insert = db.Insert("insert into online_statement (date, transactiontype, debitamount,creditamount,balance,accountno) value ('"+date.toString()+"', 'Withdraw',  '"+amt+"', '0', '"+Amount+"', '"+accno.toString()+"' ) ");
                                    out.println(insert);
                                    
                                    resp.setContentType("text/html");
                                    out.println("   <script type=\"text/javascript\">   ");
                                    out.println("   alert('Amount Withdrawn');                ");
                                    out.println("   location='withdraw_form.jsp';            ");
                                    out.println("   </script>                           ");  
